...
const ModalCard = ({ bankName, fintechUseNo, tofintechno }) => {
  ...
  const deposit = () => {
    const twoLeggedToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdWQiOiJNMjAyMjAxMzIwIiwic2NvcGUiOlsib29iIl0sImlzcyI6Imh0dHBzOi8vd3d3Lm9wZW5iYW5raW5nLm9yLmtyIiwiZXhwIjoxNjY1MzAwMjIyLCJqdGkiOiI1ZmZlZWI3MS02NTkwLTQ1Y2EtYWRiNy1jMjEzOTJhOWI1ZWYifQ.7dgaAFThjKwgzCoub9E2Vrj_Dndq6goVoLK9zMimQlc";
    const sendData = {
        cntr_account_type: "N",
